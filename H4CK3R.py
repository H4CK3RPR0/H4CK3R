...
\033[1;92m ┈┈┈▕▕╲┊┊╱▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕╲┊┊╱▏▏┈┈┈
\033[1;92m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;92m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;96mH4CK3RPR0.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;92m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;92m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;92m................\033[1;96mH4CK3RPR0\033[1;91m...............
...
\033[1;91m☞ Auther     : H4CK3RPR0
\033[1;92m☞ Facebook   : https://www.facebook.com/termux.pakistan/
\033[1;95m☞ GitHub  : https://github.com/H4CK3RPR0/
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://www.facebook.com/termux.pakistan/')
		    menu()
		else:
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update H4CK3RPR0 Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Termux Facebook Page')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/H4CK3R')
	    os.system('cd $HOME && git clone https://github.com/H4CK3RPR0/H4CK3R/')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('Facebook fb://termux.pakistan/✓')
	    psb('WellCome To H4CK3RPR0')
	    psb('Congratulations H4CK3R Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ H4CK3RPR0✓')
	    psb('🔓Password ☆ H4CK3R✓')
	    psb('Like My Facebook Page https://www.facebook.com/termux.pakistan/✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/H4CK3RPR0 && python2 H4CK3R.py')
	elif bm =='3':
	    os.system('xdg-open fb://termux.pakistan/')
	    menu()
	elif bm =='4':
